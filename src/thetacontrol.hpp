...
class ThetaControl{
    private:
        ...
        PTPParams ptpParams;
        PTP_USB ptpUSB;
        struct usb_device * thetaDev; //this is the specific usb device which is the theta
        ...
        //returns negative value (TODO check if APIs would only return positive values)
